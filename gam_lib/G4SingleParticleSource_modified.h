...
// ********************************************************************
//
// G4SingleParticleSource_modified
//
// Class description:
//
...
// G4SingleParticleSource_modified instances can be shared among threads.
...
// --------------------------------------------------------------------
#ifndef G4SingleParticleSource_modified_hh
#define G4SingleParticleSource_modified_hh 1
...
/**
 * WARNING WARNING --> see GamSingleParticleSource
 */

#include "GamSPSEneDistribution.h"

class G4SingleParticleSource_modified : public G4VPrimaryGenerator {
public:
    ...
    inline G4ThreeVector GetParticleMomentumDirection() const { return ParticleProperties.Get().momentum_direction; }
...
public:
    ...
    GamSPSEneDistribution *eneGenerator = nullptr; // WARNING FIXME <-- change here
