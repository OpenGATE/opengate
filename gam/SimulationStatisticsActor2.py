...
class SimulationStatisticsActor2(g4.GamSimulationStatisticsActor2, gam.ActorBase):
    """
    TODO
    """

    type_name = 'SimulationStatisticsActor2'

    def __init__(self, name):
        g4.GamSimulationStatisticsActor2.__init__(self, self.type_name)
