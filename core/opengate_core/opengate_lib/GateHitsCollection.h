 ...
 *
 * - Can only be created with GateHitsCollectionManager::GetInstance()->NewHitsCollection("toto")
...
public:
    ...
    std::vector<GateVHitAttribute *> &GetHitAttributes() { return fHitAttributes; }
