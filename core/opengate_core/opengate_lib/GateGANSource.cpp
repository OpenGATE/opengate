...
void GateGANSource::GeneratePrimaries(G4Event *event, double current_simulation_time) {
    ...
    if (fIsPaired) GeneratePrimariesPair(event, current_simulation_time);
    else GeneratePrimariesSingle(event, current_simulation_time);
...
void GateGANSource::GeneratePrimariesSingle(G4Event *event, double current_simulation_time) {
    // position
...
void GateGANSource::GeneratePrimariesPair(G4Event *event, double current_simulation_time) {
    // First particle
    ...
    // position
    G4ThreeVector position(fPositionX2[fCurrentIndex],
                           fPositionY2[fCurrentIndex],
