...
#ifndef GateOptnForceCommonTruncatedExp_h
#define GateOptnForceCommonTruncatedExp_h 1
...
class GateOptnForceCommonTruncatedExp : public G4VBiasingOperation {
public:
  // -- Constructor :
  GateOptnForceCommonTruncatedExp(G4String name);
  // -- destructor:
  virtual ~GateOptnForceCommonTruncatedExp();
...
public:
  ...
  G4ILawForceFreeFlight *GetForceFreeFlightLaw() { return fForceFreeFlightLaw; }
