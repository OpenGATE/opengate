...
template<>
GateTHitAttribute<GateUniqueVolumeID::Pointer>::GateTHitAttribute(std::string vname) :
    GateVHitAttribute(vname, 'U') {
}

template<>
void GateTHitAttribute<double>::FillHitWithEmptyValue() {
    threadLocalData.Get().fValues.push_back(0.0);
}

template<>
void GateTHitAttribute<int>::FillHitWithEmptyValue() {
    threadLocalData.Get().fValues.push_back(0);
}

template<>
void GateTHitAttribute<std::string>::FillHitWithEmptyValue() {
    threadLocalData.Get().fValues.push_back("");
}

template<>
void GateTHitAttribute<G4ThreeVector>::FillHitWithEmptyValue() {
...
template<>
void GateTHitAttribute<double>::FillDValue(double value) {
    threadLocalData.Get().fValues.push_back(value);
}

template<>
void GateTHitAttribute<std::string>::FillSValue(std::string value) {
    threadLocalData.Get().fValues.push_back(value);
}

template<>
void GateTHitAttribute<int>::FillIValue(int value) {
    threadLocalData.Get().fValues.push_back(value);
}
...
template<>
void GateTHitAttribute<GateUniqueVolumeID::Pointer>::FillUValue(GateUniqueVolumeID::Pointer value) {
    threadLocalData.Get().fValues.push_back(value);
}

template<>
void GateTHitAttribute<double>::FillToRoot(size_t index) const {
...
template<>
void GateTHitAttribute<int>::FillToRoot(size_t index) const {
    auto * ram = G4RootAnalysisManager::Instance();
    auto v = threadLocalData.Get().fValues[index];
...
template<>
void GateTHitAttribute<GateUniqueVolumeID::Pointer>::FillToRoot(size_t index) const {
    auto * ram = G4RootAnalysisManager::Instance();
...
template<>
std::vector<double> &GateTHitAttribute<double>::GetDValues() {
    return threadLocalData.Get().fValues;
}

template<>
std::vector<int> &GateTHitAttribute<int>::GetIValues() {
    return threadLocalData.Get().fValues;
}
...
template<>
std::vector<GateUniqueVolumeID::Pointer> &GateTHitAttribute<GateUniqueVolumeID::Pointer>::GetUValues() {
    return threadLocalData.Get().fValues;
}
