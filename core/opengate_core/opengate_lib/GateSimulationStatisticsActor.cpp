...
GateSimulationStatisticsActor::GateSimulationStatisticsActor(py::dict &user_info)
...
void GateSimulationStatisticsActor::PreUserTrackingAction(const G4Track *track) {
...
void GateSimulationStatisticsActor::EndOfSimulationWorkerAction(const G4Run * /*lastRun*/) {
