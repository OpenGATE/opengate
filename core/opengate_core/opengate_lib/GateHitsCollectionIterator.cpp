...
GateHitsCollectionIterator::GateHitsCollectionIterator(GateHitsCollection *h, size_t index) {
    fHitsCollection = h;
    fIndex = index;
}

GateHitsCollectionIterator::GateHitsCollectionIterator() {
    fIndex = 0;
}

void GateHitsCollectionIterator::TrackAttribute(const std::string &name, double **value) {
...
void GateHitsCollectionIterator::TrackAttribute(const std::string &name, G4ThreeVector **value) {
    auto *att = fHitsCollection->GetHitAttribute(name);
...
void GateHitsCollectionIterator::TrackAttribute(const std::string &name, GateUniqueVolumeID::Pointer **value) {
    auto *att = fHitsCollection->GetHitAttribute(name);
