...
void init_GateARFActor(py::module &m) {
    py::class_<GateARFActor,
        std::unique_ptr<GateARFActor, py::nodelete>, GateVActor>(m, "GateARFActor")
        .def(py::init<py::dict &>())
        .def("SetARFFunction", &GateARFActor::SetARFFunction) // FIXME, unsure what to do, seg fault after dest
