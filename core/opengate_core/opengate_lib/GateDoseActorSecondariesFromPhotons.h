...
#ifndef GateDoseActorSecondariesFromPhotons_h
#define GateDoseActorSecondariesFromPhotons_h
...
class GateDoseActorSecondariesFromPhotons : public GateVActor {

public:
  // Constructor
  GateDoseActorSecondariesFromPhotons(py::dict &user_info);
  // explicit GateDoseActorSecondariesFromPhotons(py::dict &user_info);
  // virtual ~GateDoseActorSecondariesFromPhotons();
...
#endif // GateDoseActorSecondariesFromPhotons_h
