...
public :
SimpleContainer(G4String processName,G4double energy,G4ThreeVector momentum, G4ThreeVector position,G4ThreeVector polarization,G4String name,G4double weight,G4int trackStatus,G4int nbSec,G4String flag,G4double length, G4ThreeVector prePos){
...
void SetPrePositionToSplit(G4ThreeVector prePos){
  fPrePosition = prePos;
}

G4ThreeVector GetPrePositionToSplit(){
  return fPrePosition;
}
