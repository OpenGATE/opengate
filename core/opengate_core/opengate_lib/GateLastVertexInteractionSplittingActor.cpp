...
G4double
GateLastVertexInteractionSplittingActor::RussianRouletteForAngleSurvival(
...
void GateLastVertexInteractionSplittingActor::ClearRememberedTracksAndSteps(
...
void GateLastVertexInteractionSplittingActor::RememberLastProcessInformation(
    G4Step *step) {
...
void GateLastVertexInteractionSplittingActor::
