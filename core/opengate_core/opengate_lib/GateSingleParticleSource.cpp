...
GateSingleParticleSource::GateSingleParticleSource(std::string /*mother_volume*/) {
...
void GateSingleParticleSource::SetParticleDefinition(G4ParticleDefinition *def) {
...
bool GateSingleParticleSource::TestIfAcceptAngle(const G4ThreeVector &position,
