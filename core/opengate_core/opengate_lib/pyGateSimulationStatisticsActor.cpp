...
//     }
  int EndOfRunActionMasterThread(int run_id) override {
    PYBIND11_OVERLOAD(int, GateSimulationStatisticsActor, EndOfRunActionMasterThread, run_id);
  }
...
void init_GateSimulationStatisticsActor(py::module &m) {
  ...
  py::class_<GateSimulationStatisticsActor, PyGateSimulationStatisticsActor,
      ...
      .def("EndOfRunActionMasterThread",
           &GateSimulationStatisticsActor::EndOfRunActionMasterThread)
      .def("GetCounts", &GateSimulationStatisticsActor::GetCounts)
      .def("GetCountsCurrentRun",
           &GateSimulationStatisticsActor::GetCountsCurrentRun);
}
