...
void init_G4RotationMatrix(py::module &m) {
  ...
  py::class_<G4RotationMatrix>(m, "G4RotationMatrix")
      ...
      .def("rotateX", &G4RotationMatrix::rotateX,
           py::return_value_policy::reference)
      .def("rotateY", &G4RotationMatrix::rotateY,
           py::return_value_policy::reference)
      ...
      .def("invert", &G4RotationMatrix::invert,
           py::return_value_policy::reference)

      .def("rep3x3", &G4RotationMatrix::rep3x3)
      .def("set",
           [](G4RotationMatrix &r, const CLHEP::HepRep3x3 &mat) { r.set(mat); })
