...
public:
  ...
  void ConstructParticle() override {
    PYBIND11_OVERLOAD_PURE(void, G4VUserPhysicsList, ConstructParticle, );
  }

  // Trampoline (need one for each virtual function)
  void ConstructProcess() override {
    PYBIND11_OVERLOAD_PURE(void, G4VUserPhysicsList, ConstructProcess, );
  }

  // Trampoline (need one for each virtual function)
  void SetCuts() override {
    PYBIND11_OVERLOAD(void, G4VUserPhysicsList, SetCuts, );
  }
};
