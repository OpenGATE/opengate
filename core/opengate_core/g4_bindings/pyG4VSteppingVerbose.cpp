...
void init_G4VSteppingVerbose(py::module &m) {
  py::class_<G4VSteppingVerbose>(m, "G4VSteppingVerbose")
      ...
      /*
        protected:
        static G4ThreadLocal G4VSteppingVerbose* fInstance;// pointer to the
        instance static G4ThreadLocal G4int Silent; //flag for verbosity static
        G4ThreadLocal G4int SilentStepInfo; //another flag for verbosity public:
        // with description
