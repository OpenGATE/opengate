...
void init_G4OpticalSurface(py::module &m) {
    ...
    py::enum_<G4OpticalSurfaceFinish>(m, "G4OpticalSurfaceFinish")
        ...
        .value("polishedfrontpainted", G4OpticalSurfaceFinish::polishedfrontpainted)
        ...
        .value("polishedlumirrorglue", G4OpticalSurfaceFinish::polishedlumirrorglue)
        ...
        .value("PolishedESRGrease_LUT", G4OpticalSurfaceFinish::PolishedESRGrease_LUT)
    ...
    py::class_<G4OpticalSurface, G4SurfaceProperty, std::unique_ptr<G4OpticalSurface, py::nodelete>>(m, "G4OpticalSurface")
        ...
        .def(py::init<const G4String&, G4OpticalSurfaceModel, G4OpticalSurfaceFinish, G4SurfaceType, G4double>(),
             ...
             py::arg("type") = dielectric_dielectric, 
             py::arg("value") = 1.0)
             
        .def("SetModel", &G4OpticalSurface::SetModel, py::return_value_policy::reference_internal)
        
        .def("GetModel", &G4OpticalSurface::GetModel, py::return_value_policy::copy)
        
        .def("SetType", &G4OpticalSurface::SetType, py::return_value_policy::reference_internal)
        
        .def("SetFinish", &G4OpticalSurface::SetFinish,
        py::return_value_policy::reference_internal)

        .def("SetSigmaAlpha", &G4OpticalSurface::SetSigmaAlpha, py::return_value_policy::reference_internal)

        .def("SetMaterialPropertiesTable", &G4OpticalSurface::SetMaterialPropertiesTable, py::return_value_policy::reference_internal)
