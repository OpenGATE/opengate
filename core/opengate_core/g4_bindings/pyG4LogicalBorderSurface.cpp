...
void init_G4LogicalBorderSurface(py::module &m) {
    ...
    py::class_<G4LogicalBorderSurface, std::unique_ptr<G4LogicalBorderSurface, py::nodelete>>(m, "G4LogicalBorderSurface")
        .def(py::init<const G4String&, G4VPhysicalVolume*, G4VPhysicalVolume*, G4SurfaceProperty*>())
        .def("DumpInfo",  &G4LogicalBorderSurface::DumpInfo, py::return_value_policy::copy);
}