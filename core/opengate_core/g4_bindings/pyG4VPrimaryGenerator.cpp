...
public:
  ...
  void GeneratePrimaryVertex(G4Event *evt) override {
    std::cout << "@@@@PyG4VPrimaryGenerator GeneratePrimaryVertex "
              << std::endl;
    PYBIND11_OVERLOAD_PURE(void, G4VPrimaryGenerator, GeneratePrimaryVertex,
                           evt);
  }
};

void init_G4VPrimaryGenerator(py::module &m) {
  py::class_<G4VPrimaryGenerator, PyG4VPrimaryGenerator>(m,
                                                         "G4VPrimaryGenerator")
      ...
      /*
        ...
        // static service method for checking a point is included in the
        (current) world static G4bool CheckVertexInsideWorld(const
        G4ThreeVector& pos);
        ...
        // Pure virtual method which a concrete class derived from this base
        class must
