...
void init_G4EmParameters(py::module &m) {
  ...
  py::class_<G4EmParameters, std::unique_ptr<G4EmParameters, py::nodelete>>(
      ...
      .def("Instance", &G4EmParameters::Instance,
      ...
      .def("SetDirectionalSplittingRadius",
           &G4EmParameters::SetDirectionalSplittingRadius)
      .def("GetDirectionalSplittingRadius",
           &G4EmParameters::GetDirectionalSplittingRadius)

      .def("SetDirectionalSplittingTarget",
           &G4EmParameters::SetDirectionalSplittingTarget)
      .def("GetDirectionalSplittingTarget",
      ...
      .def("ActivateForcedInteraction",
           &G4EmParameters::ActivateForcedInteraction)

      .def("ActivateSecondaryBiasing",
