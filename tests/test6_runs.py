...
source1 = sim.add_source('Test1', 'source1')
source1.particle = 'proton'
source1.energy = 150 * MeV
source1.diameter = 20 * mm
source1.n = 100

source2 = sim.add_source('Test1', 'source2')
...
source3 = sim.add_source('Test1', 'source3')
...
stats_ref.event_count = 390
stats_ref.track_count = 6806
stats_ref.step_count = 24042
stats_ref.pps = 5178
print('-' * 80)
