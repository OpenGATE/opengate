...
spect1 = gate_spect.add_ge_nm67_spect_head(sim, 'spect1', collimator_type='lehr', debug=ui.visu)
spect1.translation, spect1.rotation = gate.get_transform_orbiting(p, 'x', 180)

# spect head (debug mode = very small collimator)
spect2 = gate_spect.add_ge_nm67_spect_head(sim, 'spect2', collimator_type='lehr', debug=ui.visu)
