...
# spect head
spect = gate_spect.add_ge_nm67_spect_head(sim, 'spect', collimator_type='lehr', debug=ui.visu)
...
is_ok = gate.compare_root2(paths.output_ref / 'test043_arf_training_dataset.root',
