...
def create_simulation(geom):
    ...
    if geom == 'param':
        crystal_repeater = gate.build_param_repeater(sim, crystal.name, crystal_pixel.name, size, tr)
...
def test_output(sim):
    ...
    tols[2] = 2  # Z
    # tols[4] = 0.01  # energy
    gate.compare_root3(gate_file, hc.output, "Hits", "Hits",
    ...
    # tols[2] = 1.0  # Y
    # tols[4] = 0.02  # energy
    gate.compare_root3(gate_file, sc.output, "Singles", "Singles",
                      keys1, keys2, tols, scalings, scalings,
