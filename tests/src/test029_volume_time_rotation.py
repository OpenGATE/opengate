...
sources = gate_iec.add_spheres_sources(sim, 'iec', 'iec_source',
                                      [10, 13, 17, 22, 28, 37],
...
sources = gate_iec.add_spheres_sources(sim, 'iec', 'iec_source2',
                                      [10, 13, 17, 22, 28, 37],
                                      [ac, ac, ac, ac, ac, ac], verbose=True)
...
is_ok = gate.assert_images(paths.output_ref / 'proj029.mhd',
