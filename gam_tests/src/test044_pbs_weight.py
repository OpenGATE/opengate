...
test = gam.assert_images(
    output_path / mhd_1, output_path / mhd_2, stat, tolerance=50, ignore_value=0
)
fig1 = gam.create_2D_Edep_colorMap(output_path / mhd_1, show=True)
fig2 = gam.create_2D_Edep_colorMap(output_path / mhd_2, show=True)

# Total Edep
is_ok = gam.test_weights(
    source2.weight / source.weight, output_path / mhd_1, output_path / mhd_2
)
