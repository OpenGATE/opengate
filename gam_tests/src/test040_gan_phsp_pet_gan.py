...
root_ref = paths.output / 'test040_ref_phsp.root'  # look root generated by previous 40_aref test
...
print()
gam.warning(f'Check output phsp (the pth is not perfect, but it should be sufficient for tests')
