from .MaterialBuilder_old import *


class MaterialDatabase_old:
    """
    ...
    def __init__(self, filename, material_databases):
        ...
        self.g4_materials = {}  # FIXME store in builder ?
        self.g4_elements = {}
        self.material_builders = {}
        self.element_builders = {}
        self.current_section = "None"
        self.material_databases = material_databases
        self.read_material_builders()

    def __del__(self):
        pass

    def read_material_builders(self):
    ...
    def FindOrBuildMaterial(self, material):
        ...
        # we build and store the G4 material
        bm = b.build()
