...
def _open_trees_safely(paths, tree_name):
...
def merge_trees(
    ...
    try:
        all_data_to_merge = []
        for trees in _open_trees_safely(file_paths, tree_name):
...
def compare_branches_chi2(
    ...
    all_ok = True
    try:
        for trees in _open_trees_safely([file1_path, file2_path], tree_name):
            tree1, tree2 = trees
