...
def opengate_run(
    ...
    sim = simulation(output, File_name, job_id, number_of_particles, visu, verbose, actor, Erange)
...
def itk_merge(
    ...
    try:
        ...
        file_pattern = os.path.join(f"/home/vguittet/Documents/G10/stage1.5/output/{output}/{File_name}_trace_*.nii.gz")
        ...
        for type_name in type_list:
            for actor_name in actor_list:
                init = itk.imread(path.output/f"{File_name}_{actor_name}_1_{type_name}")
