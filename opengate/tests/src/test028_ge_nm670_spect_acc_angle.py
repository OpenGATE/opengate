...
gate.print_test(is_ok, f'Skipped particles b1 = {b1} {r1 * 100:.2f} %  vs {reference_ratio * 100:.2f} % ')

r2 = b2 / stats.counts.event_count
is_ok = (r2 - reference_ratio) / reference_ratio < tol
gate.print_test(is_ok, f'Skipped particles b2 = {b2} {r2 * 100:.2f} %  vs {reference_ratio * 100:.2f} % ')

r3 = b3 / stats.counts.event_count
is_ok = (r3 - reference_ratio) / reference_ratio < tol
gate.print_test(is_ok, f'Skipped particles b3 = {b3} {r3 * 100:.2f} %  vs {reference_ratio * 100:.2f} % ')
...
is_ok = gate.assert_images(paths.gate_output / 'projection4.mhd',
