...
translations_ring, rotations_ring = get_circular_repetition(
    20, [0 * mm, 300 * mm, 0 * mm], start_angle_deg=90, axis=[0, 0, 1]
)
...
Unit_det.size = [64 * mm, 30.0 * mm, 36 * mm]
...
Block_det.size = [16 * mm, 30.0 * mm, 36 * mm]
...
crystal_det.size = [4 * mm, 30.0 * mm, 4 * mm]
...
crystal_det_layer.size = [4 * mm, 30.0 * mm, 4 * mm]
...
source_radius = 380.0  # mm
source_hight = 255.0  # mm
...
det_total_vol = (4 * 30.0 * 4) * (4 * 9) * 5 * 4 * 20  # mm3
...
source.position.translation = [0.0 * mm, 0.0 * mm, 0.0 * mm]
