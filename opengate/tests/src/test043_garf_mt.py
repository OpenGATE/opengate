...
if __name__ == "__main__":
    ...
    is_ok = (
            utility.assert_images(test43.paths.output_ref / "test043_projection_analog.mhd", filename1, stats,
    ...
    is_ok = (
            utility.assert_images(test43.paths.output_ref / "test043_projection_analog_high_stat.mhd", filename2, stats,
