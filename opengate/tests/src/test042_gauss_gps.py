...
is_ok = gate.assert_images(paths.gate_output / 'lateral_xz_Protons_40MeV_sourceShapeGaussian-Edep.mhd',
                          sim.get_actor('doseInXZ').user_info.output,
                          stat, tolerance=10, ignore_value=0) and is_ok

print()
gate.warning('Difference for EDEP XY')
is_ok = gate.assert_images(paths.gate_output / 'lateral_xy_Protons_40MeV_sourceShapeGaussian-Edep.mhd',
...
is_ok = gate.assert_images(paths.gate_output / 'lateral_yz_Protons_40MeV_sourceShapeGaussian-Edep.mhd',
