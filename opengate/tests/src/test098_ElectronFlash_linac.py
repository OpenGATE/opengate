...
if __name__ == "__main__":
    ...
    paths = utility.get_default_test_paths(__file__, output_folder="test098_ElectronFlash_linac")
    ...
    dosephantom = fun.build_dosephantombox(sim, "Waterbox", "Water", center_z=shaper40_end+dim_z/2,dimension_x=dim_x, dimension_y=dim_y, dimension_z=dim_z, material_colors=fun.material_colors)
    ...
    dose.output_filename         = "dose_test_shaper40.mhd"
    ...
    if is_ok:
        print("test004_ElectronFlash_linac : PDD comparison test passed.")
    else:
        print("test004_ElectronFlash_linac : PDD comparison test failed. MAE = {:.3f}".format(mae))
