...
if __name__ == "__main__":
    ...
    corners = list(itertools.product([-box_half, box_half], repeat=3))
    ...
    # --- Box with UniformMagneticField (reference) ---
    ...
    uniform_field = fields.UniformMagneticField(name="B_uniform")
    uniform_field.field_vector = [0, By, 0]
    box_ref.add_field(uniform_field)

    # --- Box with MappedMagneticField (under test) ---
    ...
    mapped_field = fields.MappedMagneticField(name="B_mapped")
