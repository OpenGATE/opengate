...
def main(dependency="test072_coinc_sorter_step1_config2.py"):
    # test paths
    ...
    if not os.path.isfile(paths.output / "test72_output_2.root"):
        ...
        subprocess.call(
            ["python", paths.current / "test072_coinc_sorter_step1_config2.py"]
        )
        print("----------- End of test072_coinc_sorter_step1_config2.py -----------")

    # open root file
    root_filename = paths.output / "test72_output_2.root"
