...
if __name__ == "__main__":
    ...
    paths = utility.get_default_test_paths(__file__, output_folder="test095_ElectronFlash_linac")
    ...
    dosephantom = fun.build_dosephantombox(sim, "Waterbox", "Water", center_z=App40_end+dim_z/2,dimension_x=dim_x, dimension_y=dim_y, dimension_z=dim_z, material_colors=fun.material_colors)
    ...
    dose.output_filename         = "dose_test_app40.mhd"
    ...
    if is_ok:
        print("test_ElectronFlash_dose_app40.py : PDD comparison test passed.")
    else:
        print("test_ElectronFlash_dose_app40.py : PDD comparison test failed. MAE = {:.3f}".format(mae))
