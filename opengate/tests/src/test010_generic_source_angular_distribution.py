...
if __name__ == "__main__":
    ...
    ref_path = (
        current_path / ".." / "data" / "output_ref" / "test010" 
    )
    ...
    source.direction.histogram_phi_angle = [60 * deg, 70 * deg, 80 * deg, 100 * deg, 110 * deg, 120 * deg] 
    ...
    # tests
    stats_ref = utility.read_stat_file(ref_path / "test010_generic_source_angular_distribution_stats_ref.txt")
    ...
    is_ok = (
        utility.assert_images(
            ref_path / "test010-generic_source_angular_distribution_edep_uncertainty_ref.mhd",
            sim.output_dir / "test010-generic_source_angular_distribution_edep_uncertainty.mhd",
            stat,
            tolerance=30,
            ignore_value=1,
            sum_tolerance=1,
