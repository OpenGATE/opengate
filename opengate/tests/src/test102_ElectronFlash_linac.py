...
if __name__ == "__main__":
    ...
    paths = utility.get_default_test_paths(__file__, output_folder="test102_ElectronFlash_linac")
    ...
    phsp_plane = fun.build_dosephantombox(sim, "Phasespace_plane", "Air", center_z=EF_end+dim_z/2,dimension_x=dim_x, dimension_y=dim_y, dimension_z=dim_z, material_colors=fun.material_colors)
    ...
    phsp.output_filename = "phsp_test_nose.root"
