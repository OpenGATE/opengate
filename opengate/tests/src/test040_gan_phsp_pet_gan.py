...
def gen_cond(n):
    ...
    cond = gate_iec.generate_pos_spheres(spheres_centers, spheres_radius, n_samples, shuffle=True, rs=rs)
...
print()
gate.warning(f'Check output phsp (the pth is not perfect, but it should be sufficient for tests')
