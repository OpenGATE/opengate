...
# check
stats_ref = gate.read_stat_file(pathFile / '..' / 'data' / 'output_ref' / 'test015_confine_stats.txt')
is_ok = gate.assert_stats(stats, stats_ref, 0.03)
is_ok = is_ok and gate.assert_images(pathFile / '..' / 'data' / 'output_ref' / 'test015_confine.mhd',
