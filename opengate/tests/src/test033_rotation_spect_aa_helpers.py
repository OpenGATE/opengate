...
def create_test(sim, nb_thread=1):
    ...
    source.direction.angular_acceptance.volumes = ["spect1", "spect2"]
    ...
    source.direction.angular_acceptance.normal_tolerance = 10 * deg
    ...
    source2.direction.angular_acceptance.volumes = ["spect1", "spect2"]
    source2.direction.angular_acceptance.intersection_flag = True
    source2.direction.angular_acceptance.normal_flag = True
    source2.direction.angular_acceptance.normal_vector = [0, 0, -1]
    source2.direction.angular_acceptance.normal_tolerance = 10 * deg
