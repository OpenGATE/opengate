...
if __name__ == "__main__":
    paths = utility.get_default_test_paths(
        __file__, None, output_folder="test090_spect_config_2_in111"
    )

    # TEST 2: nm670, in111, 1 head, 2 angles
    # ref = 5e6
    ...
    # sc.detector_config.digitizer_channels = get_default_energy_windows("in111", True)
    ...
    is_ok = True
    stats.counts.runs = stats.counts.runs / sc.number_of_threads
    is_ok = check_stats_file(1847081, sc, stats, is_ok, threads=sc.number_of_threads)
