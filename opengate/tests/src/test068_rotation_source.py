...
if __name__ == "__main__":
    ...
    for i in range(10):
        ...
        rot = Rotation.from_euler("xyz",[x_rot,y_rot,z_rot], degrees=True).as_matrix()
        ...
        translation_phsp = np.dot(rot,vec_source_phsp) + np.array([x_translation,y_translation,z_translation])
    ...
    print("Number of expected events : [" +str(int(-3*err + nb_run*nb_part*nb_source)) + "," + str(int(+3*err + nb_run*nb_part*nb_source))+ "]")
