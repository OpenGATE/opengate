...
def test_spect_proj(sim, paths, proj, version="3"):
    ...
    is_ok = (
            utility.assert_images(paths.gate_output / f"projection{version}.mhd", paths.output / "proj028_offset.mhd",
    ...
    # read image and force change the offset to be similar to old Gate
    is_ok = (
            utility.assert_images(paths.output_ref / "proj028_ref.mhd", paths.output / "proj028.mhd", stats,
