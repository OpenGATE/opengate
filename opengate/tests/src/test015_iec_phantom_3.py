...
ac = 2000 * BqmL
gate_iec.add_spheres_sources(sim, 'iec', 'iec_source',
                            [10, 13, 17, 22, 28, 37],
                            # [ac, 0, 0, 0, 0, 0])
...
# check
stats_ref = gate.read_stat_file(pathFile / '..' / 'data' / 'output_ref' / 'test015_stats.txt')
is_ok = gate.assert_stats(stats, stats_ref, 0.07)
is_ok = is_ok and gate.assert_images(pathFile / '..' / 'data' / 'output_ref' / 'test015_ref.mhd',
