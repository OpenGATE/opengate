...
if __name__ == "__main__":
    ...
    bc2.blur_method = "Linear"
    bc2.blur_resolution = 0.15
    ...
    p = paths.gate_output
    stats_ref = utility.read_stats_file(p / "stats_blur2.txt")
    is_ok = utility.assert_stats(stats, stats_ref, [0.03, 0.03, 0.06])
    ...
    is_ok = (
        t49.check_root_singles(
            paths, 1, f, bc.get_output_path(), png_output="test049_singles_wb2.png"
        )
        and is_ok
    )
