...
if __name__ == "__main__":
    ...
    for process in processes :
        for type in types :
            ...
            img_fluence = img_opening(f"{sim.output_dir}/test099_processes_{type}_{process}.mhd")
            img_squared_fluence = img_opening(f"{sim.output_dir}/test099_processes_{type}_squared_{process}.mhd")
            img_uncertainty_fluence = img_opening(f"{sim.output_dir}/test099_processes_{type}_uncertainty_{process}.mhd")
