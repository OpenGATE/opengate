...
if __name__ == "__main__":
    ...
    paths = utility.get_default_test_paths(__file__, output_folder="test100_ElectronFlash_linac")
    ...
    phsp_plane = fun.build_dosephantombox(sim, "Phasespace_plane", "Air", center_z=App40_end+dim_z/2,dimension_x=dim_x, dimension_y=dim_y, dimension_z=dim_z, material_colors=fun.material_colors)
    ...
    phsp.output_filename = "phsp_test_app40.root"
    ...
    path_reference_root_phsp = paths.output_ref / "phsp_reference_app40.root"
    ...
    is_ok = utility.compare_root3(
            ...
            None,
            None,
            paths.output / "test_EF_app40.png",
            nb_bins=150,
            hits_tol = 10**6
        )
