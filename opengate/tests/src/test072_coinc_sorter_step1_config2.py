...
# config 2 is used for tests of "minDistanceXY"
...
if __name__ == "__main__":
    ...
    sim.volume_manager.material_database.add_material_weights(
        "LYSO", ["Lu", "Y", "Si", "O"], [0.31101534, 0.368765605, 0.083209699, 0.237009356], 5.37 * gcm3    
    )
   ...
   # sim.physics_manager.set_production_cut("world", "all", 1 * m)
    ...
    #hc.output = output_path /"output_test.root"
    hc.output_filename = output_path /"output_config2.root"
    hc.attributes = [
        "EventID",
        "PostPosition",
        "TotalEnergyDeposit",
    ...
    # timing
    sim.run_timing_intervals = [[0, 20000.0 * sec]]
