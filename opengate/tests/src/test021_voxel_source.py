...
source1.position.translation = gate.get_translation_between_images_center(str(ct_odd.image), str(source1.image))
...
source2.position.translation = gate.get_translation_between_images_center(str(ct_even.image), str(source2.image))
