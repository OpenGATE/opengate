...
if __name__ == "__main__":
    ...
    num_unique_hit_volumes = len(set(singles_tree["PreStepUniqueVolumeID"].array()))
    ...
    if num_unique_hit_volumes < expected_num_volumes:
        ...
        exceptions.append(
            GateImplementationError(
                f"Hits have been recorded for only {num_unique_hit_volumes} out of {expected_num_volumes} volumes"
            )
        )
