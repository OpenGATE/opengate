...
cc = output.get_actor_user_info("EnergyWindows")
...
hc_file = output.get_actor_user_info("Singles_blur").output
checked_keys = [
...
# check projection
is_ok = test_spect_proj(sim, paths, proj, version="3_blur") and is_ok
