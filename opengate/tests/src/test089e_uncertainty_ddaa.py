...
if __name__ == "__main__":
    ...
    f = output_folder / "scatter_uncertainty_ddaa.mhd"
    scatter_uncert, scatter_mean, scatter_squared_mean = (
        history_rel_uncertainty_from_files(
            output_folder / "test089_scatter_ddaa_0_counts.mhd",
            output_folder / "test089_scatter_ddaa_0_squared_counts.mhd",
            n_scatter,
            f,
        )
    )
    ...
    fn = output_folder / "mean_ddaa.mhd"
    ...
    img.CopyInformation(prim_img)
    fn = output_folder / "relative_uncertainty_ddaa.mhd"
    sitk.WriteImage(img, fn)
    print(fn)
