...
class VoxelizedPromptGammaTLE4DActor(
    ...
    def __initcpp__(self):
        g4.GateVoxelizedPromptGammaTLE4DActor.__init__(self, self.user_info)
        self.AddActions(
            {
                "BeginOfRunActionMasterThread",
                "BeginOfRunAction",
    ...
    def initialize(self):
        self.check_user_input()
        VoxelDepositActor.initialize(self)
        self.user_output.vpg.set_active(True)
        # C++ side
        self.InitializeUserInfo(self.user_info)
        self.InitializeCpp()
        self.SetPhysicalVolumeName(self.user_info.get("attached_to"))
    ...
    def EndSimulationAction(self):
        ...
        g4.GateVoxelizedPromptGammaTLE4DActor.EndSimulationAction(self)
        VoxelDepositActor.EndSimulationAction(self)


process_cls(TLEDoseActor)
process_cls(VoxelizedPromptGammaTLEActor)
process_cls(VoxelizedPromptGammaTLE4DActor)
