...
class LastVertexInteractionSplittingActorOld(g4.GateLastVertexInteractionSplittingActorOld, ActorBase):
    type_name = "LastVertexInteractionSplittingActorOld"
    ...
    def __init__(self, user_info):
        ActorBase.__init__(self, user_info)
        g4.GateLastVertexInteractionSplittingActorOld.__init__(self, user_info.__dict__)
        self.list_of_volume_name = user_info.list_of_volume_name
        self.user_info.mother = user_info.mother
