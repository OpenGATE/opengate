...
class DoseActorSecondariesFromPhotons(g4.GateDoseActorSecondariesFromPhotons, ActorBase):
    ...
    type_name = "DoseActorSecondariesFromPhotons"
    ...
    def __init__(self, user_info):
        ...
        if user_info.ste_of_mean_unbiased or user_info.ste_of_mean:
            self.user_info.ste_of_mean = True
            self.user_info.use_more_ram = True
        g4.GateDoseActorSecondariesFromPhotons.__init__(self, user_info.__dict__)
        # attached physical volume (at init)
        self.g4_phys_vol = None
        # default image (py side)
        self.py_edep_image = None
    ...
    def EndSimulationAction(self):
        g4.GateDoseActorSecondariesFromPhotons.EndSimulationAction(self)
