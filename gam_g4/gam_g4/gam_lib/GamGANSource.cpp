...
void GamGANSource::GeneratePrimariesSingle(G4Event *event, double current_simulation_time) {
    // position
...
void GamGANSource::GeneratePrimariesPair(G4Event *event, double current_simulation_time) {
    // First particle
...
void GamGANSource::GeneratePrimariesAddOne(G4Event *event,
