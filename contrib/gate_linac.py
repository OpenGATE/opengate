...
def create_material(name):
    ...
    gate.new_material(f'{name}_colli', 18 * gcm3, ['W', 'Ni', 'Fe'], [0.95, 0.0375, 0.0125])
    gate.new_material(f'{name}_flat_filter', 7.9 * gcm3, ['Cr', 'Fe', 'Ni'], [0.17, 0.75, 0.08])
    gate.new_material(f'{name}_mylar', 1.38 * gcm3, ['H', 'C', 'O'], [0.04196, 0.625016, 0.333024])
